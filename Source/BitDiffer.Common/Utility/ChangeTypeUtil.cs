...
namespace BitDiffer.Common.Utility
{
    ...
    {
        private static ChangeType breakingChangesMask = ChangeType.DeclarationChangedBreaking | ChangeType.MembersChangedBreaking | ChangeType.RemovedBreaking | ChangeType.VisibilityChangedBreaking | ChangeType.ValueChangedBreaking | ChangeType.AddedBreaking;
        ...
        {
            if (change == ChangeType.Added || change == ChangeType.AddedBreaking || change == ChangeType.RemovedBreaking || change == ChangeType.RemovedNonBreaking)
            {
                return true;
            }
