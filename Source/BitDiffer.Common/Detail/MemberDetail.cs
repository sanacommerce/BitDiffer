...
namespace BitDiffer.Common.Model
{
    ...
    public class MemberDetail : RootDetail, IHaveVisibility
    {
        ...
        {
            get { return (_visibility != Visibility.Public && _visibility != Visibility.Protected); }
        }
        ...
        protected virtual ChangeType CompareDeclaration(ICanCompare previous, bool suppressBreakingChanges)
        {
            ...
            {
                if ((!suppressBreakingChanges) &&
                    !IsVirualAddedOnly(other._declaration, _declaration) &&
                    ((_visibility == Visibility.Public || _visibility == Visibility.Protected) &&
                    (other._visibility == Visibility.Public || other._visibility == Visibility.Protected)))
                {
        ...
        private bool IsVirualAddedOnly(string first, string second)
        {
            second = second.Replace("virtual ", string.Empty);
        ...
        {
            MemberDetail other = (MemberDetail)previous;
            var isVirtual = other.Declaration != null ? other.Declaration.Contains("virtual") : false;
            return VisibilityUtil.GetVisibilityChange(other._visibility, _visibility, suppressBreakingChanges, isVirtual);
        }
